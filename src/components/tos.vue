<template>
    <div style="position: relative">
        <div class="box_type1">
            <h4 class="join_tit MAB20">회원약관</h4>
            <!-- join_agreement -->
            <div class="join_agreement MAB10" style="height: 100px">
                <!-- personal_wrap -->
                <div class="personal_wrap terms1" tabindex="0">
        ...
        <div class="box_type1">
            <h4 class="join_tit MAB20">개인정보 수집 및 이용 동의</h4>
            <div class="join_agreement MAB10">
                <!-- personal_wrap -->
                <div class="personal_wrap terms2" tabindex="0">
                    <p>
                    ...
                    <ol>
                        ...
                        <br>
                        <li style="font-size:16px; ">3. <u>개인정보의 보유 및 이용기간</u>
                            <ul>
                                <u><li>기업마당은 원칙적으로 보유기간의 경과, 개인정보의 수집 및 이용목적의 달성 등 그 개인정보가 불필요하게 되었을 때에는 지체 없이 파기합니다. 다만, 다른 법령에 따라 보존하여야 하는 경우에는 그러하지 않을 수 있습니다.  불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.</li></u>
                                <br>
                                <li>
                                    회원정보<br><b><u>-탈퇴 후 지체없이 파기</u></b>
                                    <!-- , 재동의 기간 1년 -->
                                </li>
                                <br>
                                <li>
                                    전문가정보<br>
                                    <b><u>- 전문가 정보는 기업애로상담을 위한 목적으로 수집하나 보유하지 않고 비즈니스사업단으로 시스템연계 제공함</u></b>
                                </li>
                            </ul>
                        </li>
                        <br>
            ...
            <p class="join_check">
                <input id="priAgree" v-model="priAgree" type="checkbox"><label for="priAgree" class="MAL5">개인정보 수집ㆍ이용에 동의합니다.(필수)</label>
            </p>
        </div>
        <div class="box_type1">
            ...
            <div class="join_agreement MAB10">
                <!-- personal_wrap -->
                <div class="personal_wrap terms3" tabindex="0">
                    ...
                    <ol>
                        ...
                        <li style="font-size:16px;">3. <u>개인정보의 보유 및 이용기간</u>
                            <ul>
                                <b><u><li>이용목적의 달성 후 지체없이 파기</li></u></b>
                            </ul>
                        </li>
                        <li>4. 동의거부권 및 불이익
                            <ul>
            ...
            <!-- //join_agreement -->
            <p class="join_check">
                <input id="marktPrAgreAtChk" v-model="marktPrAgreAtChk" type="checkbox"><label for="marktPrAgreAtChk" class="MAL5">마케팅/홍보를 위하여 귀하의 개인정보를 이용하는데 동의합니다.(선택)</label>
            </p>
        </div>
<!--        <div style="text-align: center">-->
<!--            <q-btn color="light-blue" :disable="!useAgree || !priAgree" label="동의함" @click="onAgree" />-->
<!--            <q-btn class="MAL10" outline color="light-blue" label="동의안함" @click="onDisagree" />-->
<!--        </div>-->
