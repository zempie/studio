    ...
    <div class="grid projectDeploy">
        <content-box>
            ...
            <div class="q-mb-lg" v-else>
                <content-box-block
                    :title="$t('projectDeploy.versionNumber')"
                    class="q-mb-xl"
                >
                    <q-input  input-class="input" readonly v-model="number"> </q-input>
                </content-box-block>
                <content-box-block
                    :title="$t('projectDeploy.versionDetail')"
                    class="q-mb-xl"
                >
                    <q-input  input-class="input" readonly v-model="version">
                    </q-input>
                </content-box-block>
            </div>
            ...
            <content-box-block
                :title="$t('projectDeploy.versionSelect')"
                class="q-pb-xl"
            >
            ...
            <content-box-block
                :title="$t('projectDeploy.cancelDeploy.title')"
                class="q-mb-xl"
                v-if="deployVersion"
            >
                <div class="hintText">
                ...
                <div class="text-left">
                    <q-btn @click="cancelDeploy" class="cancel-deploy-btn">
                        {{ $t("projectDeploy.cancelDeploy.btn") }}</q-btn
                    >
                </div>
            </content-box-block>
        </content-box>
        ...
        <content-box class="save-btn">
            <q-btn :loading="wait" color="primary" @click="deploy">
                {{ $t("save") }}</q-btn
            >
        </content-box>
    </div>
