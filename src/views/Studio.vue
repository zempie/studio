    ...
    <q-layout view="lHh Lpr lFf" class="no-drag">
        ...
        >
            <q-list>
                ...
                <q-item
                    :active="$route.name === 'TestGame'"
                    active-class="activeItem"
                    clickable
                    @click="onClickTestGame"
                >
                    <q-item-section avatar>
